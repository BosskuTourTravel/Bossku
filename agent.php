...
<div class="container mx-auto px-4 py-16 mt-10">
    <div class="min-h-screen flex flex-col items-center">
        ...
        <!-- FORM PENDAFTARAN -->
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-5xl mx-auto p-8 bg-white/80 rounded-3xl shadow-2xl border border-gray-100 backdrop-blur-md mt-10">
            <!-- Form -->
            <div class="flex flex-col justify-center">
                <div class="mb-8 flex items-center gap-3">
                    <div class="bg-[#FFCA10] rounded-full p-3 shadow-lg">
                ...
                <form id="mitraform" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="source" name="source" required
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#FFCA10] focus:outline-none shadow-sm bg-white/90 transition text-gray-700">
                    ...
                    <div class="pt-6">
                        <button type="submit"
                            class="w-full bg-gradient-to-r from-[#FFCA10] to-[#FFD84A] text-[#02335B] font-bold py-3 rounded-xl shadow-lg hover:bg-[#02335B] hover:text-[#FFCA10] hover:from-[#02335B] hover:to-[#02335B] transition duration-200 text-lg tracking-wide flex items-center justify-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="#02335B">
            ...
            <!-- Kontak & Info -->
            <div class="flex flex-col bg-gradient-to-br from-[#F9FAFB] via-[#F3F6FA] to-[#FFFAE5] p-8">
                <h2 class="text-2xl font-bold text-[#02335B] mb-4 flex items-center gap-2">
                    Kontak Kami
                </h2>
                <div class="space-y-5 text-[#02335B] text-base mb-8">
                    ...
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-4">
                        <div class="bg-[#FFCA10] rounded-full p-2 flex items-center justify-center shadow-md">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 448 512">
                                <path fill="#02335b" d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z" />
                            </svg>
                        </div>
                        <div>
