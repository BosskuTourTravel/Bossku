      ...
      <div class="row">
        ...
        <div class="col-xs-6 col-md-3">
          ...
          <ul class="footer-links">
            ...
            <li><a href="<?php echo $domain_web ?>perhitungan.php">Perhitungan</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <ul class="social-icons">
            <li>SURABAYA</li>
            <li><a class="facebook" href="https://www.facebook.com/profile.php?id=61573148797231&sk=about&_rdc=1&_rdr#"><i class="fa fa-facebook"></i></a></li>
            <li><a class="youtube" href="https://www.youtube.com/@myholidaylover"><i class="fa fa-youtube"></i></a></li>
            <li><a class="instagram" href="https://www.instagram.com/bosskutourtravel/"><i class="fa fa-instagram"></i></a></li>
