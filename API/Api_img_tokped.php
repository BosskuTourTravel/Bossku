...
function get_data($x)
{
    ...
    $total_manual_adt =  $result_profit['adt'] + $result_hp['twn'] + $fee_tl + $gt_chck_adt + $x['ltwn'] + $result_hp['adm_tokped_twn'];
    $total_manual_chd =  $result_profit['chd'] + $result_hp['cnb'] + $fee_tl + $gt_chck_chd + $x['ltwn'] + $result_hp['adm_tokped_cnb'];
    $total_manual_inf =  $result_profit['inf'] + $result_hp['inf'] + $fee_tl + $gt_chck_inf + $x['ltwn'] + $result_hp['adm_tokped_inf'];
    $total_manual_sgl =  $result_profit['adt'] + $result_hp['sgl'] + $fee_tl + $gt_chck_sgl + $x['ltwn'] + $result_hp['adm_tokped_sgl'];
