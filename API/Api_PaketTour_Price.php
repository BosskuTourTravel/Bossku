...
// echo get_price_paket('7');
function get_price_paket($x)
{
    include "db=connection.php";
    // include "TotalPrice/get_totalPrice.php";
    // include "Admin/fungsi_profit_flight.php";
    // include "TotalPrice/get_feeTL.php";
    include_once "API/Price/Api_LT_total_baru.php";
    include_once "API/Price/fungsi_profit_flight.php";
    include_once "API/Price/fungsi_gethotel_price.php";
    include_once "API/Price/fungsi_feetl.php";
    include_once "API/Price/fungsi_forLT.php";
    ...
    return json_encode(array("twn" => $twn_rp['value'], "cnb" => $cnb_rp['value'], "inf" => $inf_rp['value'], "sgl" => $sgl_rp['value'],"detail" => $result_profit['adt'] . " - " . $result_hp['twn'] . " - " . $fee_tl . " - " . $gt_chck_adt . " - " . $row_paket['ltwn'],"cek" => $data_hotel), true);

    // if ($row_paket['ltwn'] != '0') {
    //     return json_encode(array("twn" => $row_paket['twn'], "cnb" => $row_paket['cnb'], "inf" => $row_paket['inf'], "sgl" => $row_paket['sgl'],"detail" =>  $result_profit['adt'] . " - " . $result_hp['twn'] . " - " . $fee_tl . " - " . $gt_chck_adt . " - " . $row_paket['ltwn'],"cek" => $data_hotel), true);
    // } else {
    //     return json_encode(array("twn" => $twn_rp['value'], "cnb" => $cnb_rp['value'], "inf" => $inf_rp['value'], "sgl" => $sgl_rp['value'],"detail" => $result_profit['adt'] . " - " . $result_hp['twn'] . " - " . $fee_tl . " - " . $gt_chck_adt . " - " . $row_paket['ltwn'],"cek" => $data_hotel), true);
    // }
