...
function feeTL($datareq)
{
    ...
    if ($row_m['landtour'] != "undefined") {
        ...
        if (isset($row_itin['id'])) {
            ...
            return json_encode(array("adt" => $vttpax, "chd" => $vttpax, "inf" => $vttpax, "sgl" => $vttpax, "detail" => "", "breakdown" => $arr_breakdown, "break_cost_tl" => $arr_break_costtl, "feetl_cover" => $arr_feetl_cover, "costtl_cover" => $arr_ct_cover, "grand" => "", "custom" => $ttpax), true);
        }
    }
}
