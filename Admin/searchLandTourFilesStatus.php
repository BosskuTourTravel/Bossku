          ...
          <div class='col-12'>
            <div class='card'>
              <div class='card-header'>";
                ...
                echo "<div id='divCountTotal'><h3 class='card-title' style='font-weight:bold;'>LAND TOUR FILES ( Total Belum Di Input : ".$rowcount['total']." dari ".$rowcountall['total']." )</h3></div>";
                echo "<button onclick='countTotal()' class='btn-success'>Total</button>";
             ...
             $rs=mysqli_query($con,$query);
                ...
                while($row = mysqli_fetch_array($rs)){
                  ...
                  $tempStaff = '';
                  if($row['status']==0){
                    $query_staff_country = "SELECT * FROM staff_country";
                    $rs_staff_country=mysqli_query($con,$query_staff_country);
                    while($row_staff_country = mysqli_fetch_array($rs_staff_country)){
                      $cekCountry = 0;
                      $tempCountryFiles = preg_split ("/[;]+/", $row_staff_country['country']);
                      ...
                      if($cekCountry>0){
                        $query_staff2 = "SELECT * FROM login_staff WHERE id=".$row_staff_country['staff'];
                ...
                if($row['status']==$_POST['status'] AND $row['deletedStatus']==0){
...
<script>
  ...
  function countTotal(){
    ...
    var beluminput = <?php echo $beluminput; ?>;
    var data = "<h3 class='card-title' style='font-weight:bold;'>LAND TOUR FILES ( Total Belum Di Input : "+ beluminput +"dari "+ total +" )</h3>";
    $('#divCountTotal').html(data);
  }
