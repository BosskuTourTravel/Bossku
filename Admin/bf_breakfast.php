...
if ($_POST['brand']) {
      $data = [];
      $query_meal2 = "SELECT * FROM Guest_meal where id='" . $_POST['brand'] . "' Order by negara ASC";
      $rs_meal2 = mysqli_query($con, $query_meal2);
      $row_meal2 = mysqli_fetch_array($rs_meal2);

      $query_guide_bf = "SELECT * FROM Guide_Meal where type='MEAL' && kode='E' && negara='".$row_meal2['negara']."' Order by id ASC";
