        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" style="font-weight:bold;">Upload Tokopedia Rent Package</h3>
                    <div class="card-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <div class="input-group-append" style="text-align: right;">
                                <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#new_package">New Package</i></a>
                                <a class="btn btn-primary btn-sm tip" onclick="MP_Package(1,0,0)" title="Reload"><i class="fas fa-sync-alt"></i></a>
                ...
                <div class="card-body table-responsive p-0">
                    <?php
                    $query = "SELECT MP_tokopedia_rent.id,MP_tokopedia_rent.tgl,MP_tokopedia_rent.nama,login_staff.name as staff FROM MP_tokopedia_rent LEFT JOIN login_staff ON MP_tokopedia_rent.staff=login_staff.id order by id ASC";
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-sm tip" onclick="MP_Package(4,<?php echo $row['id'] ?>,0)" title="Input Product"><i class="fas fa-sign-in-alt"></i></a>
                                            ...
                                            <a class="btn btn-success btn-sm tip" href="export_tokopedia_rent_list.php?id=<?php echo $row['id'] ?>" target="_BLANK" title="Export to Excel"><i class="fa fa-file-excel"></i></a>
                                        </td>
                                    </tr>
                                <?php
                                }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#edit_package').on('show.bs.modal', function(e) {
            ...
            $.ajax({
                url: "modal_edit_tokped_rent_package.php",
                method: "POST",
                asynch: false,
                data: {
                    id: id,
    ...
    function add_package() {
        ...
        // alert(nama);
        $.ajax({
            url: "insert_package_tokopedia_rent.php",
            method: "POST",
            asynch: false,
            data: {
                nama: nama,
    ...
    function edit_package() {
        ...
        // alert(nama);
        $.ajax({
            url: "edit_package_tokopedia_rent.php",
            method: "POST",
            asynch: false,
            data: {
                nama: nama,
    ...
    function del_package(x) {
        $.ajax({
            url: "tokopedia_rent_list_delete.php",
            method: "POST",
            asynch: false,
            data: {
                id: x
