...
$queryjob = "SELECT * FROM login_staff where id=".$_SESSION['staff_id'];
                 ...
                 <div class='form-group' >
                    ...
                    <div class=form-group'>
                        <label>Jumlah job Item</label>
                            <select class='chosen' name='jobitem' id='jobitem'>
...
$(".chosen").chosen();
    ...
    $("#but_upload").click(function(){
      ...
      //  var z = "";
       ...
       // for (var i = 1; i <= $("#jobitem").val(); i++){
        //var files = $('#fileToUpload'+i)[0].files[0];
      //  fd.append('fileToUpload'+i,files);
    //    }
