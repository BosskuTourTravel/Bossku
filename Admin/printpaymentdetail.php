...
<head>
  ...
  <title>Admin Prforma Tour</title>
  ...
  <link rel="stylesheet" href="dist/js/choosen.js">
          ...
          <div class='col-12'>
            <div class='card'>
              ...
              <div class='card-body table-responsive p-0'>";
                ...
                if($_GET['tipe']==0){
                  $query = "SELECT * FROM payment_detail WHERE invoice_id = ".$_GET['id']." ORDER BY payment_number ASC";
                }elseif($_GET['tipe']==1){
                  $query = "SELECT * FROM payment_detail_visapassport WHERE invoice_id = ".$_GET['id']." ORDER BY payment_number ASC";
                }elseif($_GET['tipe']==5){
                  $query = "SELECT * FROM payment_detail_hotel WHERE invoice_id = ".$_GET['id']." ORDER BY payment_number ASC";
                }else{
                  $query = "SELECT * FROM payment_detail_flight WHERE invoice_id = ".$_GET['id']." ORDER BY payment_number ASC";
                }
