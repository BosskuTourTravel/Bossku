 ...
 <div class='row'>
          <div>
            <div class='card'>
                   ...
                   echo "<label>
                    ...
                    while($rowpackageT = mysqli_fetch_array($rspackageT)){
                      ...
                      if($cekDetailPassportT==1){
                       ...
                       echo "
                       <label>
                       <input type='checkbox' id='checkboxinvoice' name='checkboxinvoice' value='".$rowT['id']."*".$rowpackageT['checkin']."' />".$rowpackageT['checkin']."  ||  888".$rowT['id']." ( ".$rowT['tour_name']." ) - ".$rowT['category'].")</label>";
              ...
              if($_POST['tipe']==1){
                $query = "SELECT * FROM invoice WHERE id=".$_POST['id']." ORDER BY id ASC";
                $rs=mysqli_query($con,$query);
              }elseif($_POST['tipe']==2){
                $query = "SELECT * FROM invoice WHERE staff_id=".$_POST['id']." ORDER BY id ASC";
                $rs=mysqli_query($con,$query);
              }else{
                ...
                if($totalSingleR!=0){
                  ...
                  <button type='submit' onclick='insertFlight(0,".$row['id'].",0)' class='btn btn-success' style='font-size:11px;'>+ Flight</button></br>
                  </td>
