...
$arr_chck = json_decode($row_dp['chck_id'], true);
// var_dump($arr_chck);
$total_twn = 0;
$total_sgl = 0;
$total_inf = 0;
...
<body>
    <div id="content" class="container" style="max-width: 2300px;">
        ...
        <div style="padding: 5px 20px; font-size: 12px;">
            ...
            ?>
                        <div class="row">
                            <div class="col-md-2" style="border: 2px solid black; padding: 10px; font-size: 14pt;">
                ...
                <table class="table table-bordered table-sm" style="border-color: black;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo "Rp." . number_format($row_dp['c_inf'], 0, ",", ".") ?></td>
                            <td></td>
                        </tr>
