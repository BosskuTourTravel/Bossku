        ...
        <div class="col-12">
            <div class="card">
                    ...
                    <div class="input-group input-group-sm">
                        <div class="input-group-append" style="text-align: left;">
                            <div style="padding-right: 5px;">
                                <button type="button" onclick="PR_Package(9,0,0)" class="btn btn-primary  btn-sm"><i class="fa fa-plus"></i></button>
                                <button type="button" onclick="edit_tr()" class="btn btn-success  btn-sm">Edit</button>
                                <button type="button" onclick="edit_all()" class="btn btn-warning  btn-sm">Edit ALL</button>
                            </div>
                        </div>
                        <h3 class="card-title" style="font-weight:bold;">Landtrans Range List</h3>
                    </div>
                </div>
                ...
                <div class="card-body table-responsive p-2">
                    ...
                    $query = "SELECT * FROM  LTR_profit_range order by price1 ASC ";
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo  $row['adm_tokped'] . " %" ?></td>
                                    <td><?php echo  $row['adm_shopee'] . " %" ?></td>
                                    <td><?php echo  $row['adm_blibli'] . " %" ?></td>
