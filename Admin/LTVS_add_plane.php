      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title" style="font-weight:bold;">Landtour VS Overland Transport</h3>
              ...
              <div class="container">
                ...
                <div class="content">
                  ...
                  ?>
                    ...
                    <?php
                    $query_addflight = "SELECT * FROM LTVS_add_flight  where  tour_id='".$_POST['id']."' && ket=".$row_staff['cabang'];
