...
$query2 = "SELECT MP_tokopedia_rent.id,MP_tokopedia_rent.tgl,MP_tokopedia_rent.nama,login_staff.name as staff FROM MP_tokopedia_rent LEFT JOIN login_staff ON MP_tokopedia_rent.staff=login_staff.id where MP_tokopedia_rent.id='".$_GET['id']."'";
...
$query = "SELECT * FROM Upload_tokopedia_rent where mp_id='" . $_GET['id'] . "' ORDER BY id ASC limit 300";
...
header("Content-Disposition: attachment; filename=RT-" . $row2['nama'] . ".xls");
