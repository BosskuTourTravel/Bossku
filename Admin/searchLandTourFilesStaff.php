 ...
 <div class='row'>
          <div class='col-12'>
            <div class='card'>
              ...
              $querycountry2 = "SELECT * FROM staff_country WHERE staff=".$_POST['name'];
              ...
              $tempquery = $tempquery;
                ...
                $query = $tempquery . " ORDER BY id DESC";
                ...
                while($row = mysqli_fetch_array($rs)){
                  ...
                  if($row['status']==0){
                    ...
                    $query_cekstaff = "SELECT * FROM login_staff WHERE id=".$_POST['name'];
                    $rs_cekstaff=mysqli_query($con,$query_cekstaff);
                    $row_cekstaff = mysqli_fetch_array($rs_cekstaff);
                    if($row_staff2['name']!=$row_cekstaff['name']){
                      $bukanStaff = $bukanStaff + 1;
                      if($row['status']==0){
                        $beluminput = $beluminput - 1;
                      }
                    }
