...
$query = "SELECT * FROM LTE_rute where copy_id='" . $row_data['id'] . "' && master_id='" . $row_data['master_id'] . "'";
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <div class="input-group-append" style="text-align: right;">
                                ...
                                <a class="btn btn-primary btn-sm" onclick="LT_itinerary(35,<?php echo $_POST['id'] ?>,0)"><i class="fas fa-sync-alt"></i></a>
                            ...
                            <div class="card">
                                <div class="card-header" style="background-color: darkslategray; color: white;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4" style="text-align: right;">
                                            ...
                                            <button type="button" class="btn btn-success btn-sm" onclick="LT_itinerary(36,<?php echo $_POST['id'] ?>,<?php echo $row['id'] ?>)"><i class="fas fa-mountain"></i></button>
                                ...
                                <div class="card-body">
                                    <div class="tempat" style="padding: 20px 10px;">
                                        <?php
                                        $query_lte_tmp_cek = "SELECT * FROM LTE_list_tmp where rute_id='" . $row['id'] . "'";
                                        ...
                                        ?>
                                            <table class="table table-bordered table-sm">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $query_lte_tmp = "SELECT * FROM LTE_list_tmp where rute_id='" . $row['id'] . "' order by hari ASC, urutan ASC";
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td style="max-width: 150px;">
                                                                ...
                                                                <button type="button" class="btn btn-danger btn-sm" onclick="del_tmp(<?php echo $row_lte_tmp['id'] ?>,<?php echo $_POST['id'] ?>)"><i class="fa fa-trash"></i></button>
                                                            </td>
                                                        <tr>
                                                        <?php
                                                    }
