        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header" style="background-color: darkgreen; color: whitesmoke;">
                    <h3 class="card-title" style="font-weight:bold;">Print Itinerary</h3>
                    <div class="card-tools">
                        <div class="input-group input-group-sm">
                            <div class="input-group-append" style="text-align: right;">
                                ...
                                <a class="btn btn-primary btn-sm" onclick="CT_Package(1,<?php echo $_POST['id'] ?>,<?php echo $_POST['grub_id'] ?>,<?php echo $_POST['sfee_id'] ?>)"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body table-responsive">
                    ...
                    <div class="content" style="padding: 20px;">
                        <form action="cetak_print_one.php?id=<?php echo $_POST['id'] ?>&grub_id=<?php echo $_POST['grub_id'] ?>&sfee_id=<?php echo $_POST['sfee_id'] ?>" method="post" target="_blank">
