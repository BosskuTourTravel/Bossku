        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body table-responsive p-0">
                    ...
                    $query_dub = "SELECT DISTINCT tour_code FROM flight_LTnew order by tour_code ASC";
                    ...
                    <table id="example" class="table table-hover table-sm" style="width:100%; font-size: 12px;">
                        <thead>
                            <tr>
                                ...
                                <th style="max-width: 150px;">Tour Name</th>
                                <th>Rute</th>
                                <th>INT/DOM</th>
                                <th>Maskapai</th>
                                <th>Dept-Arr</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td style="max-width: 150px;"><?php echo  $row['tour_name'] ?></td>
                                    ...
                                    <?php
                                    $query_view = "SELECT * FROM  flight_LTnew where tour_code = '" . $row_dub['tour_code'] . "' && id !='" . $row['id'] . "' order by id ASC";
                                    ...
                                    ?>
                                        <tr class="detail<?php echo  $row['id'] ?>" style="display: none;">
                                            ...
                                            <td style="max-width: 150px;"><?php echo  $row_view['tour_name'] ?></td>
                                            <td style="max-width: 150px;"><?php
