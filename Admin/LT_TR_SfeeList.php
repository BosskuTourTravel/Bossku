            ...
            <div style="padding-top: 20px;">
                ...
                <table class="table  table-bordered table-sm" style="font-size: 12px;">
                    ...
                    <tbody>
                        ...
                        $no = 1;
                        $post_x = isset($_POST['x']) ? $_POST['x'] : 0;
                        $post_y = isset($_POST['y']) ? $_POST['y'] : 0;
                        $post_z = isset($_POST['z']) ? $_POST['z'] : 0;
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $query_sfee_tgl = "SELECT tgl FROM LTP_tgl_sfee where sfee_id='" . $row_sfee['id'] . "' order by tgl ASC";
                                    $rs_sfee_tgl = mysqli_query($con, $query_sfee_tgl);
                                    while ($row_sfee_tgl = mysqli_fetch_array($rs_sfee_tgl)) {
                                        echo $row_sfee_tgl['tgl'] . ", ";
                                    }
                                    ?></td>
                                ...
                                <td>
                                    <a class="badge badge-danger" onclick="del_sfee(<?php echo $row_sfee['id'] ?>,<?php echo $post_x ?>,<?php echo $post_y ?>,<?php echo $post_z ?>); add_form_sfee(<?php echo $post_x ?>,<?php echo $post_y ?>,<?php echo $post_z ?>)"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php
                            $no++;
