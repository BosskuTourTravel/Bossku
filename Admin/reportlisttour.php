          ...
          <div class='col-12'>
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>REPORT LIST TOUR</h3>
              ...
              <form role='form' method='post' action='' name='form' id='form' enctype='multipart/form-data'>
                ...
                <td><div class='card-footer'>
                  <button type='button' class='btn btn-primary' id='but_upload'>Print</button>
                </div></td>
                
                
                <td><div class='card-footer'>
                  <button type='button' class='btn btn-primary' id='but_invoice'>See Invoice</button>
                </div></td>
