...
$query_cek_addhari = "SELECT  COUNT(hari) AS plus_hari FROM  LT_AH_Main where copy_id='" . $row_data['id'] . "' && master_id='" . $row_data['master_id'] . "' && sfee_id='" . $_GET['sfee_id'] . "'";
...
<body>
    ...
    for ($c = 1; $c <= $json_day; $c++) {
        ...
        $query_cek_hari = "SELECT  id ,hari FROM  LT_AH_Main where copy_id='" . $row_data['id'] . "' && master_id='" . $row_data['master_id'] . "' && sfee_id='" . $_GET['sfee_id'] . "' && hari='$c'";
    ...
    <div style="padding: 5px 20px; font-size: 12pt;">
        ...
        <div>
            <table class="table table-bordered table-sm" style="border-color: black;">
                ...
                <tbody>
                    <?php
                    $query_master = "SELECT * FROM  LT_itinnew where kode='" . $row_data['landtour'] . "'";
                    ...
                    while ($row_master = mysqli_fetch_array($rs_master)) {
                        ...
                        //  var_export(number_format($result_feetl['adt']).",");
                    ...
                    ?>
                        <tr>
                            <td><?php echo $row_master['no_urut']  ?></td>
