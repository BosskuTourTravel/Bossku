    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input class="form-control form-control-sm" list="<?php echo $i ?>per_list<?php echo $x ?>" name="<?php echo $i ?>per<?php echo $x ?>" id="<?php echo $i ?>per<?php echo $x ?>" autocomplete="off">
