...
$queryreq = "SELECT * FROM visa_requirements";
$rsreq=mysqli_query($con,$queryreq);
$rowreq=mysqli_fetch_array($rsreq);

$queryreqs = "SELECT * FROM visa_notes";
$rsreqs=mysqli_query($con,$queryreqs);
$rowreqs=mysqli_fetch_array($rsreqs);
          ...
          <div class='col-12'>
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>FORM INSERT REQUIREMENTS & NOTES VISA</h3>
              ...
              <form role='form' method='post' action='' name='form' id='form' enctype='multipart/form-data'>
                <div class='card-body'>
                  ...
                  <div class='form-group'>
                    ...
                    <textarea id='summernote' name='editordata'>".$rowreq['description']."</textarea>
                  </div>
                  <div class='form-group'>
                    <label>Passport Notes</label>
                    <!-- <textarea class='form-control' name='rdesc' id='rdesc' placeholder='Enter Passport Notes'> </textarea> -->
                    <textarea id='summernote2' name='editordata2'>".$rowreqs['description']."</textarea>
                  </div>
...
<script>
  ...
  $(document).ready(function(){
    ...
    $("#but_upload").click(function(){
        ...
        $.ajax({
            url: 'updateVisaRequirementsNotes.php',
            type: 'post',
            data: fd,
            contentType: false,
            processData: false,
