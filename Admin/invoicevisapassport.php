          ...
          <div>
            <div class='card'>
              <div class='card-header'>
                ...
                <div class='card-tools'>
                  <div class='input-group input-group-sm' style='width: 300px;'>
                    ...
                    <select class='chosen1' name='scountry' id='scountry' onchange='searchInvoice(-1,this.value,0)' class='form-control' >
              ...
              <div  id='myMidBody'>";
                ...
                $query = "SELECT * FROM invoiceVisaPassport ORDER BY id ASC";
