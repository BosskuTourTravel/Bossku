...
if($_POST['code']==0){
	...
	$target_dirx = "../assets/i/Performa/InvoiceTour/Lampiran/";
	$target_dirx2 = "assets/i/Performa/InvoiceTour/Lampiran/";
...
$query_cek = "SELECT COUNT(*) as total FROM payment_detail_performatour WHERE paymentnumber=".$paymentnumber." AND invoice_id=".$invoiceid;
$rs_cek = mysqli_query($con,$query_cek);
$row_cek = mysqli_fetch_assoc($rs_cek);

if($row_cek<=0){

$sql = "INSERT INTO payment_detail_performatour VALUES ('',".$invoiceid.",".$paymentnumber.",".$paymentagent.",'".$date."',".$totalpayment.",".$paymentprice.",'','".$target_filex2."','','',0,'".$norek."','".$atasnama."','".$bank."',".$_SESSION['staff_id'].",0,1,'".$stamp."')";
