          ...
          <div class='col-12'>
            <div class='card'>
              ...
              <div class='card-body table-responsive p-0'>";
                ...
                $query = "SELECT * FROM payment_detail_performatour WHERE invoice_id = ".$_POST['id']." ORDER BY payment_number ASC";
                ...
                while($row=mysqli_fetch_array($rs)){
                  ...
                  if($_SESSION['type']==1 or $_SESSION['type']==2){
                    echo "<td><button type='submit' onclick='insertPayment(-2,".$row['id'].",".$row['invoice_id'].")' class='btn btn-success'><i class='fa fa-plus'></i></button></br></br></td>";
                  }else{
                    echo "<td></td>";
                  }
