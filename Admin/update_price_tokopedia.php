...
while ($row = mysqli_fetch_array($rs)) {
    ...
    for ($c = 1; $c <= $json_day; $c++) {
        ...
        while ($rowTR = mysqli_fetch_array($rsTR)) {
            if ($rowTR['id'] != "") {
                $string_fl .= "<div>" . $rowTR['maskapai'] . " " . $rowTR['dept'] . " - " . $rowTR['arr'] . " (" . $rowTR['take'] . " - " . $rowTR['landing'] . ") </div>";
            }
        }
    }
    ...
    $detail  = $desc . "</br>" . "FLIGHT" . $string_fl . "</br>" . "HOTEL" . $string_hotel . "</br>";
    ...
    if ($row['varian'] == "Adult") {
        ...
        $sql = "UPDATE Upload_tokopedia SET produk_name='" . $judul . "' ,deskripsi='" . $detail . "',Harga='" . $twn_rp['value'] . "' WHERE id='" . $row['id'] . "'";
        if (mysqli_query($con, $sql)) {
            $berhasil++;
        } else {
            $gagal++;
        }
    } else if ($row['varian'] == "Children") {
        ...
        $sql = "UPDATE Upload_tokopedia SET produk_name='" . $judul . "' ,deskripsi='" . $detail . "',Harga='" . $cnb_rp['value'] . "' WHERE id='" . $row['id'] . "'";
        if (mysqli_query($con, $sql)) {
            $berhasil++;
        } else {
            $gagal++;
        ...
        $sql = "UPDATE Upload_tokopedia SET produk_name='" . $judul . "' ,deskripsi='" . $detail . "',Harga='" . $inf_rp['value'] . "' WHERE id='" . $row['id'] . "'";
        if (mysqli_query($con, $sql)) {
            $berhasil++;
        } else {
            $gagal++;
        ...
        $sql = "UPDATE Upload_tokopedia SET produk_name='" . $judul . "' ,deskripsi='" . $detail . "',Harga='" . $sgl_rp['value'] . "' WHERE id='" . $row['id'] . "'";
        if (mysqli_query($con, $sql)) {
            $berhasil++;
        } else {
            $gagal++;
