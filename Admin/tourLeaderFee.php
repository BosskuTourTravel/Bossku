          ...
          <div class='col-12'>
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title' style='font-weight:bold;'>TOUR LEADER FEE</h3></br>
                <select class='chosen' name='tourleader' id='tourleader' onchange='searchTourLeader(0,this.value,0)'>
              <option selected='selected' value=0>Pilihan</option>";
              echo "<option selected value='1'>Tour Leader Freeland Batam</option>";
              echo "<option value='2'>Tour Leader Staff Batam</option>";
              echo "<option value='3'>Tour Leader Freeland Surabaya</option>";
              echo "<option value='4'>Tour Leader Staff Surabaya</option>";
              echo"</select>
              ...
              <div class='container'>";
              echo "<div id='divTourLeader'>";
                  echo "<center><h3>Tour Leader Freeland Batam</h3></center>";
                    $query = "SELECT * FROM tour_leader_freeland_batam ORDER BY id ASC";
