        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" style="font-weight:bold;">Upload Tokopedia Package</h3>
                    <div class="card-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <div class="input-group-append" style="text-align: right;">
                                <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#new_package">New Package</i></a>
                                <a class="btn btn-primary btn-sm tip" onclick="MP_Package(0,0,0)" title="Reload"><i class="fas fa-sync-alt"></i></a>
                ...
                <div class="card-body table-responsive p-0">
                    <?php
                    $query = "SELECT MP_tokopedia.id,MP_tokopedia.tgl,MP_tokopedia.nama,login_staff.name as staff FROM MP_tokopedia LEFT JOIN login_staff ON MP_tokopedia.staff=login_staff.id order by id ASC";
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-sm tip" onclick="MP_Package(2,<?php echo $row['id'] ?>,0)" title="Input Product"><i class="fas fa-sign-in-alt"></i></a>
                                            ...
                                            <a class="btn btn-success btn-sm tip" href="export_tokopedia_list.php?id=<?php echo $row['id'] ?>" target="_BLANK" title="Export to Excel"><i class="fa fa-file-excel"></i></a>
                                        </td>
                                    </tr>
                                <?php
                                }
...
<script type="text/javascript">
    ...
    function add_package() {
        ...
        // alert(nama);
        $.ajax({
            url: "insert_package_tokopedia.php",
            method: "POST",
            asynch: false,
            data: {
                nama: nama,
    ...
    function edit_package() {
        ...
        // alert(nama);
        $.ajax({
            url: "edit_package_tokopedia.php",
            method: "POST",
            asynch: false,
            data: {
                nama: nama,
    ...
    function del_all(x) {
        ...
        if (r == true) {
            $.ajax({
                url: "MP_tokopedia_delete_all.php",
                method: "POST",
                asynch: false,
                data: {
                    id: x
