                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <div class="input-group-append" style="text-align: right;">
                                ...
                                <a class="btn btn-primary btn-sm" onclick="LT_itinerary(34,<?php echo $_POST['id'] ?>,<?php echo $_POST['master'] ?>)"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <select class="form-control form-control-sm" id="grub" name="grub" onchange="fungsi_fl_date()">
...
<script>
    ...
    function show_fl(y, z) {
        ...
        var x = document.getElementById("grub").options[document.getElementById("grub").selectedIndex].value;
        // alert(x);
        $.ajax({
    ...
    function fungsi_fl_date() {
        var h_gb = document.getElementById("grub").options[document.getElementById("grub").selectedIndex].value;
        // alert(h_gb);
        $('.gflight').empty();
    ...
    function add_promo2(x) {
        ...
        if (r == true) {
            ...
            var flight = document.getElementById("grub").value;
