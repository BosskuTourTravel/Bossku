            ...
            <div id='filterMenu' name='filterMenu' >
              ...
              <div>";
               ...
               echo "<th>Tour Name</th>
                ...
                if($_POST['staff']!=''){
                   if($_SESSION['type']!=1 and $_SESSION['type']!=2 and $_SESSION['type']!=5 and $_SESSION['staff']!="Joana"){
                      $query = "SELECT * FROM tour_package WHERE staff=".$_SESSION['staff_id']." ORDER BY id DESC";
                    }else{
                      if($_POST['tourtype']!=''){
                        $query = "SELECT * FROM tour_package WHERE staff=".$_POST['staff']." AND tour_type LIKE '".$_POST['tourtype']."' ORDER BY id DESC";
                      }else{
                        $query = "SELECT * FROM tour_package WHERE staff=".$_POST['staff']." ORDER BY id DESC";
                      }
