            ...
            <div class="card">
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm">
                            <div class="input-group-append" style="text-align: right;">
                                <a class="btn btn-warning btn-sm tip" onclick="MP_Package(4,'<?php echo $_POST['z'] ?>',0)" title="Back" style="margin: 2px;"><i class="fas fa-arrow-left"></i></a>
                                <a class="btn btn-primary btn-sm tip" onclick="MP_Package(5,'<?php echo $_POST['id'] ?>',<?php echo $_POST['z'] ?>)" title="Reload" style="margin: 2px;"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body table-responsive p-0">
                    <div style="padding: 20px 40px; width: max-content;">
                        <?php
                        foreach ($id as $val) {
                            $query = "SELECT * FROM Upload_tokopedia_rent where id=" . $val;
...
<script type="text/javascript">
    ...
    function edit(x) {
        ...
        $.ajax({
            type: 'POST',
            url: "MP_tokopedia_edit_rent_list.php",
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
