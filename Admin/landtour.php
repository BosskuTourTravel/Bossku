 ...
 <div class='row'>
          <div>
            ...
            <div id='filterMenu' name='filterMenu' >
              ...
              $next_page = $total_records_per_page;
              $previous_page =  $total_records_per_page;
              $page_now = $total_records_per_page;
            

                if($_SESSION['type']!=1 and $_SESSION['type']!=2 and $_SESSION['type']!=5 and $_SESSION['staff']!="Joana" and $_SESSION['type']!=6){
                  $query = "SELECT * FROM tour_package WHERE staff=".$_SESSION['staff_id']." ORDER BY dateInsert DESC LIMIT ".$total_records_per_page;
                  $rs=mysqli_query($con,$query);
                }else{
                  $query = "SELECT * FROM tour_package ORDER BY dateInsert DESC LIMIT ".$total_records_per_page;
                  $rs=mysqli_query($con,$query);
                }
                ...
                // echo "<div id='wait' style='display:none;width:50%;height:50%;border:1px solid black;position:absolute;top:50%;padding:2px;'><img src='https://www.2canholiday.com/assets/i/loading.gif' width='50%' height='50%' /><br>Loading..</div>";
