...
if ($_POST['z'] == '0') {
	...
	$query2 = "SELECT id FROM LT_itin_profit_range_bossku order by id ASC";
		...
		<div class='col-12'>
			<div class="card">
				<div class="card-header">
					<div class="card-title">FROM Update Profit</div>
					...
					<form>
						<div id="dynamic_field">
							...
							foreach ($data as $value) {
								$query = "SELECT * FROM LT_itin_profit_range_bossku where id='" . $value . "'";
