          ...
          <div class='col-12'>
            <div class='card'>
              ...
              <div class='card-body table-responsive p-0'>";
                ...
                $query = "SELECT * FROM payment_detail WHERE invoice_id = ".$_POST['id']." ORDER BY payment_number ASC";
                ...
                while($row=mysqli_fetch_array($rs)){
                  ...
                  echo "<td><button type='submit' onclick='updatePayment(0,".$row['id'].",".$row['invoice_id'].")' style='font-size:13px;' class='btn btn-warning'><i class='fa fa-edit' aria-hidden='true''></i></button>
