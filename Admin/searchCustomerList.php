 ...
 <div class='row'>
          <div>
            <div class='card'>
              ...
              <div  id='myMidBody'>";
                if($_POST['tipe']==1){
                  $query = "SELECT * FROM customer_list WHERE phone_number LIKE '".$_POST['name']."' ORDER BY id DESC";
                }elseif($_POST['tipe']==2){
                  $query = "SELECT * FROM customer_list WHERE request_date LIKE '".$_POST['name']."' ORDER BY id DESC";
                }elseif($_POST['tipe']==3){
                  $query = "SELECT * FROM customer_list WHERE month_planning LIKE '%".$_POST['name']."%' ORDER BY id DESC";
                }elseif($_POST['tipe']==4){
                  $query = "SELECT * FROM customer_list WHERE city LIKE '%".$_POST['name']."%' ORDER BY id DESC";
                }elseif($_POST['tipe']==5){
                  ...
                  if($country!=''){
                    if($month!=''){
                      $query = "SELECT * FROM customer_list WHERE destination LIKE '%".$country."%' AND month_planning LIKE '".$month."' ORDER BY id DESC";
                    }else{
                      $query = "SELECT * FROM customer_list WHERE destination LIKE '%".$country."%' ORDER BY id DESC";
                    }
                  }else if($month!=''){
                    $query = "SELECT * FROM customer_list WHERE month_planning LIKE '".$month."' ORDER BY id DESC";
                  }else{
                    $query = "SELECT * FROM customer_list ORDER BY id DESC";
                  }
                  
                }elseif($_POST['tipe']==6){
                  $query = "SELECT * FROM customer_list WHERE category LIKE '".$_POST['name']."' ORDER BY id DESC";
                }else{
                  $query = "SELECT * FROM customer_list ORDER BY id DESC";
                }
                //echo $query."</br>";
