...
$query = "SELECT * FROM exclusion WHERE id=".$_POST['id'];
          ...
          <div class='col-12'>
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>UPDATE EXCLUSION PACKAGE</h3>
                <div class='card-tools'>
                  <div class='input-group input-group-sm' style='width: 150px;'>
                    <input type='text' name='table_search' class='form-control float-right' placeholder='Search'>
                    
                    <div class='input-group-append'>
                      <button type='submit' onclick='reloadPage(-7,".$_POST['tid'].",0)' class='btn btn-default'><i class='fa fa-arrow-left'></i></button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <form role='form' method='post' action='' name='form' id='form' enctype='multipart/form-data'>
                <div class='card-body'>
                  ...
                  <div class='form-group'>
                    ...
                    <!-- <textarea class='form-control' name='desc' id='desc' value='".$row['name']."' placeholder='Enter Description'>".$row['name']."</textarea> -->
                    <textarea id='summernote' name='editordata' placeholder='Enter Description'>".$row['name']."</textarea>
                  </div> ";
