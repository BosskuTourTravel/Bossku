...
$queryperforma = "SELECT * FROM performa_price WHERE id = ".$_POST['id'];
              ...
              <form role='form' method='post' action='insertPricePackage.php'>
                ...
                <div class=form-group'>
                  ...
                  <div class=form-group'>
                    ...
                    <input type='text' class='form-control' name='staffcom2' id='staffcom2' value='".$rowperforma['staffcom2']."' placeholder='Enter StaffCom2'>
                  </div>
                  ...
                  <div class=form-group'>
                    ...
                    <input type='text' class='form-control' name='discount' id='discount' value='".$rowperforma['discount']."' placeholder='Enter Discount'>
                  </div>
