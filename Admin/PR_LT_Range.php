        ...
        <div class="col-12">
            <div class="card">
                    ...
                    <div class="input-group input-group-sm">
                        <div class="input-group-append" style="text-align: left;">
                            <div style="padding-right: 5px;">
                                <button type="submit" onclick="PR_Package(6,0,0)" class="btn btn-primary  btn-sm"><i class="fa fa-plus"></i></button>
                        ...
                        <h3 class="card-title" style="font-weight:bold;">LT Range List</h3>
                    </div>
                </div>
                ...
                <div class="card-body table-responsive p-0">
                    ...
                    $query = "SELECT * FROM  LT_itin_profit_range_bossku order by price1 ASC ";
