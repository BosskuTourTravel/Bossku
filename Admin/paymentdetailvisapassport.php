          ...
          <div class='col-12'>
            <div class='card'>
              ...
              <div class='card-body table-responsive p-0'>";
                ...
                $query = "SELECT * FROM payment_detail_visapassport WHERE invoice_id = ".$_POST['id']." ORDER BY payment_number ASC";
                ...
                while($row=mysqli_fetch_array($rs)){
                  ...
                  <td><img id='myImg".$row['id']."' onclick='showImage(".$row['id'].")' src='https://2canholiday.com/".$row['payment_photo']."' style='height:150px;width:100px;'><div id='myModal".$row['id']."'  class='modal' data-backdrop='dynamic'>
                  ...
                  echo "<td><button type='submit' onclick='updatePayment(1,".$row['id'].",".$row['invoice_id'].")'' style='font-size:13px;' class='btn btn-warning'><i class='fa fa-edit' aria-hidden='true''></i></button>
