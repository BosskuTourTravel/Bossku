                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <div class="input-group-append" style="text-align: right;">
                                ...
                                <a class="btn btn-primary btn-sm" onclick="LT_itinerary(92,<?php echo $_POST['id'] ?>,<?php echo $_POST['row'] ?>)"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <form>
                                ...
                                ?>
                                    <div class="tmp-button-update" id="tmp-button-update">
                                        <button type="button" class="btn btn-success" onclick="fungsi_update_meal(<?php echo $row_data['copy_id'] ?>)">UPDATE</button>
                                    </div>
                                <?php
                                } else {
                                ?>
                                    <div class="meal-button-add" id="meal-button-add">
                                        <button type="button" class="btn btn-warning" onclick="fungsi_add_meal(<?php echo $row_data['copy_id'] ?>)">ADD</button>
                                    </div>
