          ...
          <div class='col-12'>
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title'>FORM INSERT COUNTRY</h3>
...
<script>
  ...
  $(document).ready(function(){
    ...
    $("#but_upload").click(function(){
        ...
        var b = document.getElementById("continent").options[document.getElementById("continent").selectedIndex].value;
        var files = $('#fileToUpload')[0].files[0];
        var files2 = $('#fileToUpload2')[0].files[0];
        fd.append('name',a);
        fd.append('continent',b);
