        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" style="font-weight:bold;">Data Promo PT BTH List</h3>
                ...
                <div class="card-body table-responsive p-0">
                    <table id="example" class="table table-striped table-bordered table-sm" style="width:100%; font-size: 12px;">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $query_dp = "SELECT * FROM DP_ptsub2 where ket='3' order by negara ASC , city ASC,twn DESC";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="min-width: 100px;">
                                        <a class="btn btn-warning btn-sm" href="preview_DP_ptsub.php?id=<?php echo $value['id'] ?>" target="_BLANK"><i class="fa fa-print"></i></a>
