          ...
          <div class='col-12'>
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title' style='font-weight:bold;'>Inclusion : ".$rowtour['tour_name']."</h3>
              ...
              <div class='card-body table-responsive p-0'>";
                ...
                $query = "SELECT * FROM inclusion WHERE tour_package=".$_POST['id']." ORDER BY id ASC";
                ...
                while($row = mysqli_fetch_array($rs)){
                  ...
                  <button type='submit' onclick='delInclusion(".$row['id'].",".$_POST['id'].")' style='font-size:13px;' class='btn btn-danger'><i class='fa fa-trash' aria-hidden='true'></i></button>
                  </td>
                  </tr>
                  <tr>";
                }
...
<script>
  function delInclusion(x,y){
    var txt;
    var r = confirm("Are you sure to delete?");
    if (r == true) {
      $.ajax({
        url:"delInclusion.php",
        method: "POST",
        asynch: false,
        data:{id:x},
