...
<div class="content-wrapper" style="width: 250%;">
		...
		<div class='col-12'>
			<div class="card">
				<div class="card-header">
					<div class="card-title">FROM Update FLIGHT</div>
								...
								<div class="row">
									...
									<div class="col" style="max-width: 200px;">
										<div class="form-group">
											...
											<input type="number" class="form-control form-control-sm" id="bagasi" name="bagasi[]" value="<?php echo $row['bagasi'] ?>">
										</div>
									</div>
									<div class="col" style="max-width: 200px;">
										<div class="form-group">
											...
											<input type="number" class="form-control form-control-sm" id="bg_price" name="bg_price[]" value="<?php echo $row['bagasi_price'] ?>">
										</div>
									</div>
									<div class="col" style="max-width: 200px;">
										<div class="form-group">
											...
											<input type="number" class="form-control form-control-sm" id="st_price" name="st_price[]" value="<?php echo $row['seat_price'] ?>">
										</div>
									</div>
									<div class="col" style="max-width: 200px;">
										<div class="form-group">
											...
											<input type="number" class="form-control form-control-sm" id="bf" name="bf[]" value="<?php echo $row['bf'] ?>">
										</div>
									</div>
									<div class="col" style="max-width: 200px;">
										<div class="form-group">
											...
											<input type="number" class="form-control form-control-sm" id="ln" name="ln[]" value="<?php echo $row['ln'] ?>">
										</div>
									</div>
									<div class="col" style="max-width: 200px;">
										<div class="form-group">
											...
											<input type="number" class="form-control form-control-sm" id="dn" name="dn[]" value="<?php echo $row['dn'] ?>">
										</div>
									</div>
									<div class="col" style="max-width: 200px;">
										<?php if ($u == 1) {
										...
										<div class="form-group">
											<input type="number" class="form-control form-control-sm" id="tax" name="tax[]" value="<?php echo $row['tax'] ?>">
										</div>
									</div>
								</div>
							<?php
				...
				<div class="card-footer">
					<button type="button" class="btn btn-success btn-sm" onclick="update_flight()">UPDATE</button>
				</div>
			</div>
		</div>
	</div>
	...
	<script>
		function update_flight() {
			...
			var id = $("input[name='tour_id[]']").map(function() {
				return this.value;
			}).get();
