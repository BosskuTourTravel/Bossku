            ...
            <div class='card'>
              ...
              <div  id='myMidBody'>";
                ...
                while($row=mysqli_fetch_array($rs)){
                  ...
                  ".$row['payment']."</br>
                  <button type='submit' onclick='insertPayment(0,".$row['id'].",0)' class='btn btn-success' style='font-size:8px;'><i class='fa fa-plus'></i></button></br></br>
                  <button onclick='reloadPayment(0,".$row['id'].",0)' class='btn btn-primary' style='font-size:8px;'>Cek</button></td>
