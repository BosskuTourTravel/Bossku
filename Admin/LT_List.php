        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body table-responsive p-0">
                    <?php
                    $query = "SELECT LT_itinerary2.* ,login_staff.name ,LT_itinnew.benua ,LT_itinnew.negara,LT_itinnew.kota,LT_itinnew.ket FROM LT_itinerary2 LEFT JOIN login_staff ON LT_itinerary2.status=login_staff.id LEFT JOIN LT_itinnew ON LT_itinerary2.landtour=LT_itinnew.kode GROUP BY LT_itinnew.kode ORDER by LT_itinerary2.id ASC";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div>
                                                <p style="color: green;">
                                                    <?php
                                                    if (isset($row['status'])) {
                                                        echo "Created by " . $row['name'] . " on " . $row['tgl'];
                                                    }
                                                    ?>
                                                </p>
                                            </div>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <a class="btn btn-info btn-sm" onclick="LAN_Package(1,<?php echo $row['id'] ?>,0)" title="Landtour Price"><i class="fas fa-luggage-cart"></i></a>
                                            <a class="btn btn-secondary btn-sm" title="Compare Price" data-toggle="modal" data-target="#modal_compare" data-id="<?php echo $row['id'] ?>"><i class="fa fa-tags"></i></a>
                    ...
                    <div class="modal fade" id="modal_compare" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Compare Pricelist Landtour</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <div class="modal-data-compare"></div>
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#modal_compare').on('show.bs.modal', function(e) {
            var id = $(e.relatedTarget).data('id');
            $.ajax({
                url: "modal_compare.php",
                method: "POST",
                asynch: false,
                data: {
                    id: id,
