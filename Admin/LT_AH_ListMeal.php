        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" style="font-weight:bold;">Landtour ADD Hari Meal</h3>
                    <div class="card-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <div class="input-group-append" style="text-align: right;">
                                ...
                                <a class="btn btn-primary btn-sm" onclick="AH_Package(2,<?php echo $_POST['id'] ?>,<?php echo $_POST['grub_id'] ?>,<?php echo $_POST['sfee_id'] ?>)"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container" style="padding: 20px;">
                        <div class="meal" id="meal">
                            <form>
                                ...
                                $queryMeal = "SELECT * FROM  LT_AH_ListMeal where tour_id='" . $row_data['copy_id'] . "' && grub_id='".$_POST['grub_id']."' && hari='$hari'";
                                ...
                                ?>
                                    <div class="tmp-button-update" id="tmp-button-update">
                                        <button type="button" class="btn btn-success" onclick="fungsi_update_meal(<?php echo $row_data['copy_id'] ?>,<?php echo $_POST['sfee_id'] ?>,<?php echo $_POST['grub_id'] ?>)">UPDATE</button>
                                    </div>
                                <?php
                                } else {
                                ?>
                                    <div class="meal-button-add" id="meal-button-add">
                                        <button type="button" class="btn btn-warning" onclick="fungsi_add_meal(<?php echo $row_data['copy_id'] ?>,<?php echo $_POST['sfee_id'] ?>,<?php echo $_POST['grub_id'] ?>)">ADD</button>
                                    </div>
...
<script>
    function fungsi_add_meal(x,y,z) {
    ...
    function fungsi_update_meal(x,y,z) {
        var hari = $("input[name=hari]").val();
        let formData = new FormData();
