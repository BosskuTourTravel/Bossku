              ...
              <form role='form' method='post' action='insertPricePackage.php'>
                ...
                <div class=form-group'>
                  ...
                  <div class=form-group'>
                    ...
                    <input type='text' class='form-control' name='subagent' id='subagent' placeholder='Enter Supplier ( Diisi Nominal / Persentase dengan 100% )'>
                  </div>
                ...
                <div class='card-footer'>
                  <button type='button' class='btn btn-primary' onclick='insertPerformaPrice()'>Submit</button>
                </div>
              </form>
            </div>
...
<script>
  function insertPerformaPrice(){
    ...
    $.ajax({
        ...
        method: "POST",
        asynch: false,
        data:{id:x,name:y,persentase:y,nominal:z,agentcom:c,flag:d,range:e,staffcom:f,subagent:g,marketingcom:h,discount:i,staffcom2:k},
