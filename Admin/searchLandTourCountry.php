          ...
          <div class='col-12'>
            ...
            <div id='filterMenu' name='filterMenu' >
              ...
              <div>";
                ...
                if($_POST['name']!=0){
                  $query_country2 = "SELECT * FROM country WHERE id = ".$_POST['name'];
                  $rs_country2=mysqli_query($con,$query_country2);
                }else{
                  $query_country2 = "SELECT * FROM country ";
                  $rs_country2=mysqli_query($con,$query_country2);
                }
               ...
               if($_POST['continent']!=0){
                     ...
                     if($_POST['tourtype']!=''){
                          ...
                          $query = "SELECT * FROM tour_package WHERE staff=".$_SESSION['staff_id']." AND continent=".$_POST['continent']." AND tour_type LIKE '".$_POST['tourtype']."' AND country LIKE '%".$row_country2['id']."%' ORDER BY id DESC";
                         }else{
                           $query = "SELECT * FROM tour_package WHERE continent=".$_POST['continent']." AND tour_type LIKE '".$_POST['tourtype']."' AND country LIKE '%".$row_country2['id']."%' ORDER BY id DESC";
                         }
                      ...
                      if($_SESSION['type']!=1 and $_SESSION['type']!=2 and $_SESSION['type']!=5 and $_SESSION['staff']!="Joana" and $_SESSION['type']!=6){
                          $query = "SELECT * FROM tour_package WHERE WHERE staff=".$_SESSION['staff_id']." AND continent=".$_POST['continent']." AND country LIKE '%".$row_country2['id']."%' ORDER BY id DESC";
                         }else{
                           $query = "SELECT * FROM tour_package WHERE continent=".$_POST['continent']." AND country LIKE '%".$row_country2['id']."%' ORDER BY id DESC";
                         }
                      
                    }

                  
                }elseif($_POST['tourtype']!=''){
                     ...
                     if($_SESSION['type']!=1 and $_SESSION['type']!=2 and $_SESSION['type']!=5 and $_SESSION['staff']!="Joana" and $_SESSION['type']!=6){
                      $query = "SELECT * FROM tour_package WHERE staff=".$_SESSION['staff_id']." AND country LIKE '%".$row_country2['id']."%' ORDER BY id DESC";
                    }else{
                      $query = "SELECT * FROM tour_package WHERE country LIKE '%".$row_country2['id']."%' ORDER BY id DESC";
                    }
