                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <div class="input-group-append" style="text-align: right;">
                                ...
                                <a class="btn btn-primary btn-sm" onclick="LT_itinerary(91,<?php echo $_POST['id'] ?>,<?php echo $_POST['row'] ?>)"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body table-responsive p-0">
                    <div class="container" style="padding: 20px;">
                        <div class="list-tempat" id="list-tempat">
                            <?php
                            $statusTmp = 0;
                            $queryTmp = "SELECT * FROM  LTHR_add_listTmp where tour_id='" . $row_data['copy_id'] . "' && hari='$hari'";
                            ...
                            <form>
                                <div style="border: 2px solid; border-color:darkgreen; padding: 10px; margin-bottom: 5px;">
                                    ...
                                    <div id="dynamic_field">
                                        <?php
                                        if ($rowTmp['id'] != "") {
                                            $queryTmp2 = "SELECT * FROM  LTHR_add_listTmp where tour_id='" . $row_data['copy_id'] . "' && hari='$hari'";
                                ...
                                ?>
                                    <div class="tmp-button-update" id="tmp-button-update">
                                        <button type="button" class="btn btn-success" id='but_upload4' onclick="fungsi_update_tmp(<?php echo $row_data['copy_id'] ?>)">UPDATE</button>
                                    </div>
                                <?php
                                } else {
                                ?>
                                    <div class="tmp-button-add" id="tmp-button-add">
                                        <button type="button" class="btn btn-warning" id='but_upload3' onclick="fungsi_add_tmp(<?php echo $row_data['copy_id'] ?>)">ADD</button>
                                    </div>
