...
$arr_hotel = [];
$query_hotel_data2 = "SELECT LAN_Hotel_List.*,hotel_lt.name,hotel_lt.city FROM LAN_Hotel_List INNER JOIN hotel_lt ON LAN_Hotel_List.hotel_id=hotel_lt.id WHERE LAN_Hotel_List.master_id='" . $_GET['tour_id'] . "'";
        ...
        ?>
            <div class="content-itin" style="padding-bottom: 15px;">
                <div class="container">
                    ...
                    <div class="hotel">
                        <?php
                        $query_hotel_data = "SELECT LAN_Hotel_List.*,hotel_lt.name,hotel_lt.city FROM LAN_Hotel_List INNER JOIN hotel_lt ON LAN_Hotel_List.hotel_id=hotel_lt.id  WHERE LAN_Hotel_List.master_id='" . $row_data['id'] . "' && hari='" . $c . "' order by LAN_Hotel_List.urutan ASC";
        ...
        <div class="harga" style="padding: 10px 20px;">
            ...
            <table class="table table-bordered table-sm" style="border-color: black;">
                ...
                <tbody>
                    <?php
                    $no = 1;
                    $loop = $_POST['num_pax'] - $_POST['foc'] - $_POST['guide'];
                    for ($i = 1; $i <= $loop ; $i++) {
                        $val_pax = "";
                        $pax_tour = $i;
                        $bagi = intval($i);
