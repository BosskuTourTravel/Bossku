<?php
function add_rute($value)
{
    include "../db=connection.php";
    $queryTambah = "SELECT * FROM  LT_add_hari where master_id='" . $value['master'] . "' && copy_id='" . $value['copy'] . "' && hari='" . $value['c'] . "'";
...
?>
        <div class="row" style="padding-top: 10px;">
            ...
            <div class="col-10" style="border: 2px solid black;  padding: 10px; border-left: 0px;">
                <div style="font-size: 14pt;"><u><b><?php echo $rowTambah['rute'] ?></b></u>
                    <?php
                    $queryMealH = "SELECT * FROM  LTHR_add_meal where tour_id='" . $value['copy'] . "' && hari='" . $rowTambah['hari'] . "'";
                ...
                <?php
                $queryTR = "SELECT * FROM  LT_add_transport where master_id='" . $value['master'] . "' && copy_id='" . $value['copy'] . "' && hari='" .  $value['c'] . "' order by urutan ASC";
    ...
    <?php
        ...
        $query_rute_hide = "SELECT * FROM LTE_rute where copy_id='" . $value['copy'] . "' && hari='" . $value['cek_hari'] . "'";
...
function transport($value)
{
    ...
    $queryTR = "SELECT * FROM  LT_add_transport where master_id='" . $value['master'] . "' && copy_id='" . $value['copy'] . "' && hari='" . $value['hari_asli'] . "' order by urutan ASC";
    $rsTR = mysqli_query($con, $queryTR);
    $detail = "";
    $type = "";
    while ($rowTR = mysqli_fetch_array($rsTR)) {
...
function tmp($value)
{
    ...
    <div class="tempat" style="padding-left: 20px; font-size: 12pt;">
        <?php
        if ($value['lte_rute'] != "") {
            $query_lte_tmp = "SELECT * FROM LTE_list_tmp where rute_id='" . $value['lte_rute'] . "' order by urutan ASC";
...
function hotel_for_lt($value)
{
    ...
    $query_hotel_data = "SELECT * FROM LTHR_add_hotel WHERE copy_id='" . $value['copy'] . "' and master_id='" . $value['master'] . "' && hari='" . $value['hari'] . "'";
