            ...
            <div class="card">
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm">
                            <div class="input-group-append" style="text-align: right;">
                                <a class="btn btn-warning btn-sm tip" onclick="MP_Package(7,'<?php echo $_POST['z'] ?>',0)" title="Back" style="margin: 2px;"><i class="fas fa-arrow-left"></i></a>
                                <a class="btn btn-primary btn-sm tip" onclick="MP_Package(8,'<?php echo $_POST['id'] ?>',<?php echo $_POST['z'] ?>)" title="Reload" style="margin: 2px;"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body table-responsive p-0">
                    <div style="padding: 20px 40px; width: max-content;">
                        <?php
                        foreach ($id as $val) {
                            $query = "SELECT * FROM Upload_tokopedia_land where id=" . $val;
                        ...
                        ?>
                            <div class="row g-3">
                                ...
                                <div class="col">
                                    <a class="btn btn-info btn-sm tip" href="../Data_promo/landtour_thumbnail.php?id=<?php echo $row['master_id'] ?>" target="_BLANK" title="Cetak Flayer">Print Flayer</a>
                                </div>
...
<script type="text/javascript">
    ...
    function edit(x) {
        ...
        $.ajax({
            type: 'POST',
            url: "MP_tokopedia_edit_land_list.php",
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
