            ...
            <table class="table table-bordered table-sm" style="border-color: black;">
                ...
                <tbody>
                    ...
                    foreach ($arr_num as $num) {
                        ...
                        // echo  "rent :" . $val_rent . "+ Hotel :" . $val_hotel_twn . "+ Guide : " . $val_guide_custom . "+ foc:" . $val_foc_custom . "+ g_mail : " . $guest_meal . "+ adm :" . $adm_price . "+ gadm: " . $guide_adm . "+ gfoc: " . $foc_adm . "+ ghotel: " . $guide_hotel . "+fhotel:" . $foc_hotel."</br>";
