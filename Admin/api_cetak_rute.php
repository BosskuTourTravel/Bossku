            ...
            <div class="container">
                <div class="row" style="padding-bottom: 10px;">
                    <div class="col-9" style="font-weight: bold;">
                        <div>
                            <h5 style="margin: 0px; text-transform: uppercase;"><?php echo "DAY " . $hari . " " . $rowTambah['rute'] ?></h5>
                        </div>
                ...
                <div class="tempat" style="font-size: 12pt;">
                    <p style="margin: 0px 0px; text-align: justify;">
                        ...
                        while ($rowTmp2 = mysqli_fetch_array($rsTmp2)) {
                            ...
                            if (!isset($row_ops['id'])) {
                                // var_dump("on");
                                if (isset($row_tempat22['id'])) {
                                    echo "<b>" . $row_tempat22['tempat2'] . "</b> " . $row_tempat22['keterangan'] . ", ";
                                }
                            } else {
                                //disini
                                if (isset($row_tempat22['id'])) {
                                    ...
                                    if (isset($row_ops['id'])) {
                                        // var_dump($row_ops['highlight']."pppp");
                                        ...
                                        if ($row_ops['optional'] == '1') {
                                            // var_dump("onic");
                                            echo "<b> [ Optional ] " . $row_tempat22['tempat2'] . "</b> " . $row_tempat22['keterangan'] . ", ";
                                        } else {
                ...
                <div class="gambar" style="padding: 10px;">
                    <div class="row">
                        <?php
                        $query_sel = "SELECT * FROM  selected_img_tmp where tour_id ='" . $value['master'] . "' && hari='" . $value['c'] . "' limit 3";
        ...
        <div class="content-itin" style="padding-bottom: 15px;">
            <div class="container">
                <div class="row" style="padding-bottom: 10px;">
                    <div class="col-9" style="font-weight: bold;">
                        <div>
                            <h5 style="margin: 0px; text-transform: uppercase;"><?php echo "DAY " . $value['c'] . " " . $nama_rute ?></h5>
                        </div>
                        <div style="font-weight: 9pt; color: gray; font-style: italic;"><?php echo $b . " " . $l . " " . $d ?></div>
                ...
                tmp_AH($data_print);
                ?>
                <div class="hotel" style="padding-bottom: 15px;">
                    <?php
                ...
                <div class="gambar" style="padding: 10px;">
                    <div class="row">
                        <?php
                        $query_sel = "SELECT * FROM  selected_img_tmp where tour_id ='" . $value['master'] . "' && hari='" . $value['cek_hari'] . "' limit 3";
                        $rs_sel = mysqli_query($con, $query_sel);
                        while ($row_sel = mysqli_fetch_array($rs_sel)) {
                            $query_stmp = "SELECT List_tempat_img.id ,List_tempat_img.link,List_tempat_img.summer_img,List_tempat_img.winter_img,List_tempat_img.autumn_img,List_tempat.tempat FROM List_tempat_img LEFT JOIN List_tempat ON List_tempat_img.tmp_id=List_tempat.id where List_tempat_img.tmp_id='" . $row_sel['tmp'] . "'";
                            $rs_stmp = mysqli_query($con, $query_stmp);
...
?>
    <div class="tempat" style="font-size: 12pt; padding-bottom: 0px;">
        <p style="margin: 0px 0px; text-align: justify;">
            <?php
            if ($value['lte_rute'] != "") {
                ...
                while ($row_lte_tmp = mysqli_fetch_array($rs_lte_tmp)) {
                    ...
                    echo "<b>" . $row_tempat_lte['tempat2'] . "</b> " . $row_tempat_lte['keterangan'] . ", ";
                }
            }
            // default
