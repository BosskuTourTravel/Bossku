          ...
          <div class='col-12'>
            <div class='card'>
              ...
              <div class='card-body table-responsive p-0'>";
                ...
                $query = "SELECT * FROM payment_detail_performavisapassport WHERE invoice_id = ".$_POST['id']." ORDER BY payment_number ASC";
                ...
                while($row=mysqli_fetch_array($rs)){
                  ...
                  <td><img id='myImg2".$row['id']."' onclick='showImage2(".$row['id'].")' src='https://2canholiday.com/".$row['img_lampiran']."' style='height:150px;width:100px;'>
                  ...
                  if($_SESSION['type']==1 or $_SESSION['type']==2){
                    echo "<td><button type='submit' onclick='insertPayment(-3,".$row['id'].",".$row['invoice_id'].")' class='btn btn-success'><i class='fa fa-plus'></i></button></br></br></td>";
                  }else{
                    echo "<td></td>";
                  }
...
<script>
  function delPaymentDetail(x,y){
    ...
    if (r == true) {
     $.ajax({
        url:"delPaymentDetailPerformaTour.php",
        method: "POST",
        asynch: false,
        data:{id:x},
