		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					FORM INSERT PROFIT LANDTRANS RANGE
				</div>
					...
					<form>
						<div id="dynamic_field">
							<div class="row">
								...
								<div class="col-md">
									<div class="form-group">
										<label>Admin Tokped </label>
										<input type="Text" class="form-control form-control-sm" id="admin_tokped" name="admin_tokped[]">
									</div>
								</div>
								<div class="col-md">
									<div class="form-group">
										<label>Admin Shopee</label>
										<input type="Text" class="form-control form-control-sm" id="admin_shopee" name="admin_shopee[]">
									</div>
								</div>
								<div class="col-md">
									<div class="form-group">
										<label>Admin Blibli</label>
										<input type="Text" class="form-control form-control-sm" id="admin_blibli" name="admin_blibli[]">
									</div>
								</div>
								<div class="col-md">
									<div class="form-group">
...
<script>
	...
	function add_row() {
		i++;
		$.ajax({
			url: "PR_Landtrans_range_field.php",
			method: "POST",
			asynch: false,
			data: {
				i: i
