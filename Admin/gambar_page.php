            ...
            <div class="card">
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm">
                            <div class="input-group-append" style="text-align: right;">
                                ...
                                <a class="btn btn-primary btn-sm" onclick="CT_Package(4,<?php echo $_POST['id'] ?>,<?php echo $_POST['grub_id'] ?>,<?php echo $_POST['sfee_id'] ?>)"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body table-responsive">
                    ...
                    <div class="content" style="padding: 20px;">
                        <form action="../Data_promo/landtour_master_tokped.php?id=<?php echo $_POST['id'] ?>&grub_id=<?php echo $_POST['grub_id'] ?>&sfee_id=<?php echo $_POST['sfee_id'] ?>" method="post" target="_blank">
                            ...
                            <div style="text-align: center; padding: 10px;">
                                ...
                                <!-- <a class="btn btn-warning btn-sm tip" href="../Data_promo/landtour_master.php?id=<?php echo $row['id'] ?>" target="_BLANK" title="Cetak Flayer Market"> <i class="fas fa-images"></i></a> -->
                            </div>
                        </form>
