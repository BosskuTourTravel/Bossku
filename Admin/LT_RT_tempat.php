...
$query_data = "SELECT * FROM LT_Rute WHERE id=" . $_POST['row_id'];
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm" style="width: 150px;">
                            <div class="input-group-append" style="text-align: right;">
                                <a class="btn btn-warning btn-sm" onclick="RT_Package(0,<?php echo $_POST['id'] ?>,<?php echo  $row_data ['grub_id'] ?>,<?php echo $row_data ['sfee_id'] ?>)"><i class="fa fa-chevron-circle-left"></i></a>
                                <a class="btn btn-primary btn-sm" onclick="RT_Package(1,<?php echo $_POST['id'] ?>,<?php echo  $_POST['row_id'] ?>,0)"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body table-responsive p-0">
                    <div class="container" style="padding: 20px;">
                        <div class="list-tempat" id="list-tempat">
                            <?php
                            $statusTmp = 0;
                            $queryTmp = "SELECT * FROM  LT_RT_list_tmp where rute_id='" . $row_data['id'] . "' && hari='$hari'";
                            ...
                            <form>
                                <div style="border: 2px solid; border-color:darkgreen; padding: 10px; margin-bottom: 5px;">
                                    ...
                                    <div id="dynamic_field">
                                        <?php
                                        if ($rowTmp['id'] != "") {
                                            $queryTmp2 = "SELECT * FROM  LT_RT_list_tmp where rute_id='" . $row_data['id'] . "' && hari='$hari'";
