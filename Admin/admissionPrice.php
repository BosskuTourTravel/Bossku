          ...
          <div class='col-12'>
            <div class='card'>
              <div class='card-header'>
                <h3 class='card-title' style='font-weight:bold;'>Admission Price/h3>
              ...
              <div class='container' style='font-size:13px; max-width:50px important'>
                    ...
                    <div id='divInput'>
                              <div class='form-row align-items-center'> 
                                   <div class='col-2'>
                                        <label>Name</label>
                                            <input type='text' class='form-control' name='admission_name' id='admission_name' placeholder='Enter Admission Name'>
                                    </div>
                                     <div class='col-2'>
                                    ...
                                    <div class='col-2'>
                                        <label>Category Desc</label>
                                            <input type='text' class='form-control' name='category_desc' id='category_desc' placeholder='Enter Category Desc'>
                                    </div>
                                    <div class='col-2'>
                            ...
                            <div class='form-row align-items-center'>
                            	<div class='col-2'>
                                        ...
                                        <select class='chosen' name='physic' id='physic'>
                                        <option selected='selected' value=1>Ada</option>
                                        <option selected='selected' value=0>Tidak Ada</option>
                                        </select>
                                    </div>
                                   <div class='col-2'>
                                        <label>E-Tix</label></br>
                                        <select class='chosen' name='etix' id='etix'>
                                        <option selected='selected' value=1>Ada</option>
                                        <option selected='selected' value=0>Tidak Ada</option>
                                        </select>
                                    </div>
                                    <div class='col-2'>
                                        ...
                                        <select class='chosen' name='redeem' id='redeem'>
                                        <option selected='selected' value=1>Ada</option>
                                        <option selected='selected' value=0>Tidak Ada</option>
                                        </select>
                                    </div>
                            ...
                            <div class='form-row align-items-center'>
                                    <div class='col-2'>
                                     ...
                                     <div class='col-2'>
                                        <label>Buy Senior Price</label>
                                            <input type='text' class='form-control' name='senior_price' id='senior_price' value='0' placeholder='Enter Adt Price'>
                                    </div>
                                     <div class='col-2'>
                                        <label>Buy Junior Price</label>
                                            <input type='text' class='form-control' name='junior_price' id='junior_price' value='0' placeholder='Enter Adt Price'>
                                    </div>
                                     <div class='col-2'>
                                        <label>Buy Chd Price</label>
                                            <input type='text' class='form-control' name='chd_price' id='chd_price' value='0' placeholder='Enter Adt Price'>
                                    </div>
                                    <div class='col-2'>
                                        <label>Buy Inf Price</label>
                                            <input type='text' class='form-control' name='inf_price' id='inf_price' value='0' placeholder='Enter Adt Price'>
                                    </div>
                              </div>
                              <div class='form-row align-items-center'>
                                    <div class='col-2'>
                                        <label>Sell Adt Price</label>
                                            <input type='text' class='form-control' name='sell_adt_price' id='sell_adt_price' value='0' placeholder='Enter Adt Price'>
                                    </div>
                                     <div class='col-2'>
                                        <label>Sell Senior Price</label>
                                            <input type='text' class='form-control' name='sell_senior_price' id='sell_senior_price' value='0' placeholder='Enter Adt Price'>
                                    </div>
                                     <div class='col-2'>
                                        <label>Sell Junior Price</label>
                                            <input type='text' class='form-control' name='sell_junior_price' id='sell_junior_price' value='0' placeholder='Enter Adt Price'>
                                    </div>
                                     <div class='col-2'>
                                        <label>Sell Chd Price</label>
                                            <input type='text' class='form-control' name='sell_chd_price' id='sell_chd_price' value='0' placeholder='Enter Adt Price'>
                                    </div>
                                    <div class='col-2'>
                                        <label>Sell Inf Price</label>
                                            <input type='text' class='form-control' name='sell_inf_price' id='sell_inf_price' value='0' placeholder='Enter Adt Price'>
                                    </div>
                              </div>
                              ...
                              <div class='form-row align-items-center'>
                                    <div class='col-2'>
                                        <label>Adt Desc</label>
                                            <input type='text' class='form-control' name='adt_desc' id='adt_desc' placeholder='contoh : (4-12 yrs)'>
                                    </div>
                                     <div class='col-2'>
                                        <label>Senior Desc</label>
                                            <input type='text' class='form-control' name='senior_desc' id='senior_desc' placeholder='contoh : (4-12 yrs)'>
                                    </div>
                                     <div class='col-2'>
                                        <label>Junior Desc</label>
                                            <input type='text' class='form-control' name='junior_desc' id='junior_desc' placeholder='contoh : (4-12 yrs)'>
                                    </div>
                                     <div class='col-2'>
                                        <label>Chd Desc</label>
                                            <input type='text' class='form-control' name='chd_desc' id='chd_desc' placeholder='contoh : (4-12 yrs)'>
                                    </div>
                                    <div class='col-2'>
                                        <label>Inf Desc</label>
                                            <input type='text' class='form-control' name='inf_desc' id='inf_desc' placeholder='contoh : (4-12 yrs)'>
                                    </div>
                              </div>
                              <div class='form-row align-items-center'>
                                     <div class='col-6'>
                                    ...
                                    <div class='col-6'>
                                        <label>Remarks</label>
                                            <textarea id='summernote2' name='remarks'></textarea>
                                    </div>
              ...
              <div class='container-fluid'>";
                ...
                $admissioncode = $row['id'] + 45000;
                echo "<td>".$admissioncode."</td>";
