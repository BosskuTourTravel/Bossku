...
// alert(ttotal);
  $.ajax({
        url:"searchTransport4b.php",
        method: "POST",
        asynch: false,
        data:{totaltr:totaltr,totaltr2:totaltr2,totaltr3:totaltr3,totaltr4:totaltr4,totaltr5:totaltr5,totaltr6:totaltr6,t:t,ttotal:ttotal},
