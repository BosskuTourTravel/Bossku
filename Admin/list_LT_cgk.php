        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" style="font-weight:bold;">List Landtour Jakarta</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $data['judul'] ?></br><b><?php echo $row_lt['kode'] ?></b></br><?php echo $detail_visa ?></br>
                                            <!-- <p style="color: salmon;"><?php echo "Created by : " . $row_staff['name'] ?></p> -->
                                              ...
                                              <?php 
                                               $query_addflight = "SELECT * FROM LT_add_flight  where  tour_id='".$row['id']."' && ket=4";
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-sm" href="preview_makeLT.php?id=<?php echo $row['id'] ?>&cabang=4" target="_BLANK"><i class="fa fa-print"></i></a>
                                            <a class="btn btn-primary btn-sm" href="preview_all_LT.php?id=<?php echo $row['id'] ?>&cabang=4" target="_BLANK"><i class="fa fa-print"></i></a>
                                            <?php
                                            if ($cabang == 4 or $cabang == 1) {
                                            ?>
