...
$sql = "INSERT INTO flight_quotation VALUES('',".$airlines.",'".$from_fix."','".$to_fix."','".$out_fix."','".$type_price."','".$kurs_price."','".$adt_price."','".$chd_price."','".$inf_price."','".$kurs_tax."','".$tax_adt_price."','".$tax_chd_price."','".$tax_inf_price."','".$flight_type."','".$flight_category."',".$country_to.",".$city_from.",".$city_to.",".$city_out.",".$total_seat.",".$total_foc.",".$tax_foc.",".$itinerary_category_arrival.",".$itinerary_category_departure.",'".$remarks."',".$_SESSION['staff_id'].",'".$stamp."','0000-00-00')";
...
if($tempcek==0){
	...
	if($type==2){
		...
		$sql2 = "INSERT INTO flight_quotation_detail VALUES('',".$row_detail['id'].",'".$airlines_pil."','".$airlines_code."','".$flight_date."','".$from."','".$to."','".$destination_from."','".$destination_to."','".$departure_time."','".$arrival_time."',1,'".$stamp."')";
		...
		if (mysqli_query($con, $sql2)) {
			...
			for ($x = 0; $x < $counttb; $x++) {
				...
				$sql2 = "INSERT INTO flight_quotation_detail VALUES('',".$row_detail['id'].",'".$airlines_pil."','".$airlines_code."','".$flight_date."','".$from."','".$to."','".$destination_from1."','".$destination_to1."','".$departure_time."','".$arrival_time."',".$transit_type.",'".$stamp."')";
			...
			$sql2 = "INSERT INTO flight_quotation_detail VALUES('',".$row_detail['id'].",'".$airlines_pil2."','".$airlines_code2."','".$flight_date2."','".$from2."','".$to2."','".$destination_from2."','".$destination_to2."','".$departure_time2."','".$arrival_time2."',2,'".$stamp."')";
			...
			for ($x = 0; $x < $counttp; $x++) {
				...
				$sql2 = "INSERT INTO flight_quotation_detail VALUES('',".$row_detail['id'].",'".$airlines_pil."','".$airlines_code."','".$flight_date."','".$from."','".$to."','".$destination_from2."','".$destination_to2."','".$departure_time."','".$arrival_time."',".$transit_type.",'".$stamp."')";
