...
$query_paket = "SELECT * FROM paket_tour_online where id=" . $_GET['id'];
    ...
    <div id="content" class="container" style="max-width: 2300px;">
        ...
        <div style="text-align: center; font-family: sans-serif; padding: 30px 10px; font-weight: bold;">
            <H1 style="text-transform: uppercase;">
                <?php
                $query_judul = "SELECT * FROM LT_change_judul WHERE copy_id='" . $row_data['id'] . "' && grub_id='" . $row_paket['grub_id'] . "'";
        ...
        for ($c = 1; $c <= $json_day; $c++) {
            ...
            $query_cek_hari = "SELECT  id ,hari FROM  LT_AH_Main where copy_id='" . $row_data['id'] . "' && master_id='" . $row_data['master_id'] . "' && grub_id='" . $row_paket['grub_id'] . "' && hari='$c'";
            ...
            if ($row_cek_hari['id'] != "") {
                $data_print = array(
                    ...
                    "sfee_id" => $row_paket['sfee_id'],
                    "grub_id" => $row_paket['grub_id'],
                    "c" => $c,
                    "date" => $date,
                ...
                <table class="table table-bordered table-sm" style="border-color: black;">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <td><?php echo  $row_paket['pax'] ?> </td>
                            <td><?php echo "Rp." . number_format($row_paket['twn'], 0, ",", ".") ?></td>
                            <td><?php echo "Rp." . number_format($row_paket['sgl'], 0, ",", ".") ?></td>
                            <td><?php echo "Rp." . number_format($row_paket['cnb'], 0, ",", ".") ?></td>
                            <td><?php echo "Rp." . number_format($row_paket['inf'], 0, ",", ".") ?></td>
                            <td></td>
                        <?php
                        } else if ($row_paket['ltwn'] != '0') {
                        ?>
                            <td style="min-width: 200px;"><?php echo  $rowflight_logo['nama'] ?></td>
                            <td><?php echo $start_date ?></td>
                            <td>
        ...
        <div style="padding: 5px 20px; font-size: 12px;">
            <div class="row">
                <div class="col-6">
                    <div>
                        <?php
                        $query2 = "SELECT * FROM LT_add_transport_baru where master_id='" . $row_data['master_id'] . "' && copy_id='" . $row_paket['tour_id'] . "' && grub_id='" . $row_paket['grub_id'] . "' && sfee_id='" . $row_paket['sfee_id'] . "' order by hari ASC, urutan ASC";
                        ...
                        ?>
                            <table class="table table-bordered table-sm" style="border-color: black; font-weight: normal; font-size: 10pt;">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT * FROM  LT_add_transport_baru where master_id='" . $row_data['master_id'] . "' && copy_id='" . $row_paket['tour_id'] . "' && grub_id='" . $row_paket['grub_id'] . "' && sfee_id='" . $row_paket['sfee_id'] . "' order by hari ASC, urutan ASC";
