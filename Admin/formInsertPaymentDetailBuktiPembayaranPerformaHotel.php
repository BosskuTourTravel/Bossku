                ...
                <div class='card-tools'>
                  <div class='input-group input-group-sm' style='width: 150px;'>
                    ...
                    <div class='input-group-append'>
                      <button type='submit' onclick='insertPayment(-7,".$_POST['invoice'].",0)' class='btn btn-default'><i class='fa fa-arrow-left'></i></button>
                    </div>
                  </div>
                </div>
              </div>
  ...
  $(document).ready(function(){
    ...
    $("#but_upload").click(function(){
        ...
        if(document.getElementById("fileToUpload").files.length != 0){
           ...
           fd.append('code',0);
           $.ajax({
           	url: 'uploadPaymentDetailPerformaHotel.php',
           	type: 'post',
           	data: fd,
           	contentType: false,
           	processData: false,
