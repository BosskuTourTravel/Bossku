...
include "../db=connection.php";
                            ...
                            <div class='form-row align-items-center'>
                                <div class='col-12'>";
                                $querya = "SELECT * FROM performa_price_standart_flight WHERE flight_type LIKE 'FIT' ORDER BY performa_price_range_flight ASC";
...
//var_dump($totalpax);
echo "<input type='text' id='flight_type' name='flight_type' value='FIT' hidden>";
