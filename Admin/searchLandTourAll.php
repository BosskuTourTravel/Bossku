                ...
                if($_POST['continent']!=0){
                     ...
                     if($_POST['tourtype']!=''){
                     	...
                     	if($_SESSION['type']!=1 and $_SESSION['type']!=2 and $_SESSION['type']!=5 and $_SESSION['staff']!="Joana" and $_SESSION['type']!=6){
                     		$query = "SELECT * FROM tour_package WHERE staff=".$_SESSION['staff_id']." AND continent=".$_POST['continent']." AND tour_type LIKE '".$_POST['tourtype']."' ORDER BY id DESC";
                     	}else{
                     		$query = "SELECT * FROM tour_package WHERE continent=".$_POST['continent']." AND tour_type LIKE '".$_POST['tourtype']."' ORDER BY id DESC";
                     	}


                    }else{
                      if($_SESSION['type']!=1 and $_SESSION['type']!=2 and $_SESSION['type']!=5 and $_SESSION['staff']!="Joana" and $_SESSION['type']!=6){
                          $query = "SELECT * FROM tour_package WHERE WHERE staff=".$_SESSION['staff_id']." AND continent=".$_POST['continent']." ORDER BY id DESC";
                         }else{
                           $query = "SELECT * FROM tour_package WHERE continent=".$_POST['continent']." ORDER BY id DESC";
                         }
