...
$val_pax = "";
$pax_tour = intval($_GET['pax']);
$bagi = intval($_GET['pax']);
...
$arr_hotel = [];
$query_hotel_data2 = "SELECT LAN_Hotel_List.*,hotel_lt.name,hotel_lt.city FROM LAN_Hotel_List INNER JOIN hotel_lt ON LAN_Hotel_List.hotel_id=hotel_lt.id WHERE LAN_Hotel_List.master_id='" . $_GET['tour_id'] . "' && LAN_Hotel_List.status='" . $_POST['guest_hotel'] . "'";
...
while ($row_guide2 = mysqli_fetch_array($rs_guide2)) {
    ...
    $grand_foc2 = $grand_foc2 + $bf_price2 + $ln_price2 + $dn_price2;
    // var_dump($fee_price2 ."+". $sfee_price2 ."+". $bf_price2 ."+". $ln_price2 ."+". $dn_price2 ."+". $vt_price2."</br>");
    // var_dump($grand_guide2."</br>");
}
// $val_guide =  $_POST['guide'] * ($grand_guide2 / $bagi);
// $val_foc = $_POST['foc'] * ($grand_foc2 / $bagi);
//  var_dump($arr_hotel);
...
$val_foc_custom = $_POST['foc'] * ($grand_foc2 / $bagi);

// var_dump("guide ++++ ".$_POST['guide']. "*" ."(".$grand_guide2. "/". $bagi.")</br>");
...
// echo  "rent :" . $val_rent . "+ Hotel :" . $val_hotel_twn . "+ Guide : " . $val_guide_custom . "+ foc:" . $val_foc_custom . "+ g_mail : " . $guest_meal . "+ adm :" . $adm_price . "+ gadm: " . $guide_adm . "+ gfoc: " . $foc_adm . "+ ghotel: " . $guide_hotel . "+fhotel:" . $foc_hotel;
// echo $_POST['guide']."*". "(".$grand_guide2 ."/". $bagi.")";
// $total_twn = $val_guide + $val_hotel_twn + $val_rent;
// $total_sgl = $val_guide + $val_hotel_sgl + $val_rent;
// $total_chd = $val_guide + $val_hotel_chd + $val_rent;
// $total_inf = 0 + $val_hotel_inf + 0;
                    ...
                    <div class="hotel">
                        ...
                        while ($row_hotel_data = mysqli_fetch_array($rs_hotel_data)) {
                            if (isset($row_hotel_data['id'])) {
                                echo "<b>HOTEL : " . $row_hotel_data['name'] . " , " . $row_hotel_data['city'] . "</b></br>";
                            } else {
                                ...
                                if (isset($rowHotel['id'])) {
                                    if ($rowHotel['hotel'] == "1") {
                                        echo "<b>HOTEL : Hotel Name TBA </b></br>";
                                    }
                                }
                            }
                        }
