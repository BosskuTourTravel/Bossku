        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body table-responsive p-0">
                    <?php
                    $query = "SELECT * FROM  LTSUB_itin where cabang='3' order by id ASC";
                    $rs = mysqli_query($con, $query);
                    $no = 1;
                    ?>
                    <div style="padding: 20px;">
                        <table id="tb-pt-bth" class="table table-striped table-bordered" style="width:100%; font-size: 12px;">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Nama</th>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            $get_sub_menu = hide_sub_menu(28, $role_check);
                                            if ($get_sub_menu != 0) {
                                            ?>
                                            ...
                                            ?>
                                            <?php
                                            if ($rowStaff2['cabang'] == '3') {
                                                $get_sub_menu = hide_sub_menu(29, $role_check);
                                                if ($get_sub_menu != 0) {
                                            ?>
                                                ...
                                                $get_sub_menu = hide_sub_menu(30, $role_check);
                                                if ($get_sub_menu != 0) {
                                                ?>
                                                ...
                                                if ($rowSH['id'] == "") {
                                                    $get_sub_menu = hide_sub_menu(31, $role_check);
                                                    if ($get_sub_menu != 0) {
                                                    ?>
