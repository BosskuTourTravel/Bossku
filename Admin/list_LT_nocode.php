                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-warning btn-sm" onclick="LT_include(5,<?php echo $row['id'] ?>,0)"><i class="fa fa-plane"></i></a>
                                            <a class="btn btn-success btn-sm" onclick="LT_include(6,<?php echo $row['id'] ?>,0)"><i class="fa fa-coffee"></i></a>
                                            <a class="btn btn-info btn-sm" onclick="LT_include(7,<?php echo $row['id'] ?>,0)"><i class="fa fa-bed"></i></a>
                                            <a class="btn btn-secondary btn-sm" onclick="LT_include(8,<?php echo $row['id'] ?>,0)"><i class="fa fa-user"></i></a>
                                            <!-- <a class="btn btn-primary btn-sm" onclick=""><i class="fa fa-bullhorn"></i></a> -->
                                            <a class="btn btn-secondary btn-sm" onclick=""><i class="fa fa-database"></i></a>
