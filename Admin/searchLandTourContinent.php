            ...
            <div id='filterMenu' name='filterMenu' >
              ...
              <div>";
                ...
                if($_POST['continent']!=0){
                  $query_continent = "SELECT * FROM continent WHERE id = ".$_POST['continent'];
               ...
               echo "<th>Tour Name</th>
                ...
                <tbody id='myTable'>";
                 while($row_continent = mysqli_fetch_array($rs_continent) and $countx!=1){

                  $query_country2 = "SELECT * FROM country WHERE continent=".$row_continent['id'];
                  $rs_country2=mysqli_query($con,$query_country);
                  $row_country2 = mysqli_fetch_array($rs_country);

                if($_POST['tourtype']!=''){

                   if($_POST['minperson']!=''){
                     if($_SESSION['type']!=1 and $_SESSION['type']!=2 and $_SESSION['type']!=5 and $_SESSION['staff']!="Joana" and $_SESSION['type']!=6){
                        $query = "SELECT * FROM tour_package WHERE staff=".$_SESSION['staff_id']." AND tour_type LIKE '".$_POST['tourtype']."' AND minperson=".$_POST['minperson']." AND continent LIKE '".$row_continent['id']."' AND country LIKE '%".$row_country2['id']."%' ORDER BY id DESC";
                      }else{
                        $query = "SELECT * FROM tour_package WHERE tour_type LIKE '".$_POST['tourtype']."' AND minperson=".$_POST['minperson']." AND continent LIKE '".$row_continent['id']."' AND country LIKE '%".$row_country2['id']."%' ORDER BY id DESC";
                      }
                  }else{
                    $query = "SELECT * FROM tour_package WHERE tour_type LIKE '".$_POST['tourtype']."' AND continent LIKE '".$row_continent['id']."' AND country LIKE '%".$row_country2['id']."%' ORDER BY id DESC";
                  }
                  
                }elseif($_POST['minperson']!=''){

                   if($_SESSION['type']!=1 and $_SESSION['type']!=2 and $_SESSION['type']!=5 and $_SESSION['staff']!="Joana" and $_SESSION['type']!=6){
                      $query = "SELECT * FROM tour_package WHERE staff=".$_SESSION['staff_id']." AND minperson=".$_POST['minperson']." AND country LIKE '%".$row_country2['id']."%' ORDER BY id DESC";
                    }else{
                      $query = "SELECT * FROM tour_package WHERE minperson=".$_POST['minperson']." AND continent LIKE '".$row_continent['id']."' AND continent LIKE '".$row_continent['id']."' AND country LIKE '%".$row_country2['id']."%' ORDER BY id DESC";
                    }
                  
                }else{
                     if($_SESSION['type']!=1 and $_SESSION['type']!=2 and $_SESSION['type']!=5 and $_SESSION['staff']!="Joana" and $_SESSION['type']!=6){
                      $query = "SELECT * FROM tour_package WHERE staff=".$_SESSION['staff_id']." AND continent LIKE '".$row_continent['id']."' ORDER BY id DESC";
                    }else{
                      $query = "SELECT * FROM tour_package WHERE continent LIKE '".$row_continent['id']."' ORDER BY id DESC";
                    }
                ...
                while($row = mysqli_fetch_array($rs)){
                  $tempCityF = preg_split ("/[\s;]+/", $row['country']);

                
                 for($xu=0; $xu<count($tempCityF);$xu++){
                  $querycityF = "SELECT * FROM country WHERE id=".$tempCityF[$xu];
