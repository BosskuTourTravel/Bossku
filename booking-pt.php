...
<div class="content" style="margin:auto;">
    <div class="card" style="padding: 10px; margin: 20px;">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form action="checkout.php?id=<?php echo $_GET['id'] ?>" method="post">
