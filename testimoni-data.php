...
$testimonials = [
    ...
    [
        'name' => 'Budi Santoso',
        'message' => 'Naik Hiace dari Surabaya bareng teman-teman tuh seru banget! Begitu sampai lokasi, acaranya seru dan makanannya juara banget!',
        'tour_name' => '3D2N Semarang Solo',
    ],
    [
        'name' => 'Rina Ayu',
